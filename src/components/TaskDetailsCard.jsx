    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-red-600 dark:text-red-400 mb-4">Error: {error}</h2>
          <Link to="/alltasks" className="text-blue-600 dark:text-blue-400 hover:underline">
            Go back to tasks
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-500 dark:bg-black py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className={`p-8 ${task.completed ? 'bg-linear-to-r from-green-500 to-green-600' : 'bg-linear-to-r from-yellow-500 to-yellow-600'}`}>
            <div className="flex items-center justify-between">
              ...
              {/* {task.completed ? (
                <div className="bg-white bg-opacity-30 backdrop-blur-sm rounded-full p-4">
          ...
          <div className="p-8">
            ...
            <div className="flex gap-4 mt-8">
              <Link
                to="/alltasks"
                className="flex-1 flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
              >
