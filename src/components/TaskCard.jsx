...
const TaskCard = ({ task, onToggleStatus }) => {  // Add onToggleStatus prop
  
  const handleToggle = () => {
    onToggleStatus(task.id, !task.completed)  // Call parent function
  }
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          {task.completed ? (
            <button
              ...
              hover:bg-green-200 dark:hover:bg-green-700 transition-colors cursor-pointer"  // Add hover effect
            >
            ...
            <button
              ...
              hover:bg-yellow-200 dark:hover:bg-yellow-700 transition-colors cursor-pointer"  // Add hover effect
            >
              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
